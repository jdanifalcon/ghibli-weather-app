...
function initialize() {
  ...
  function setBackgroundTheme(shortDescription) {
    if (
      ...
      mainThemeSource.src = `https://raw.githubusercontent.com/Anna2049/totoro-weather-app/main/media/themes/nature/back-rain-heavy.gif`;
  ...
  function displayForecastHourly(response) {
    ...
    horizontalDivider.src = "https://raw.githubusercontent.com/Anna2049/totoro-weather-app/main/media/six-chibi-totoro.png";
  }
